<template>
  <div class="overflow-hidden rounded-md border border-term-border bg-term-panel shadow-[0_0_40px_rgba(0,255,65,0.05)]">
    <div class="flex items-center gap-2 border-b border-term-border bg-black/30 px-4 py-2.5">
      ...
      <span class="ml-2 truncate text-xs text-term-dim">{{ title }}</span>
    </div>
